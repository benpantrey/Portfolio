...
3. Specify the following information:
   ...
   - **Storage**: Choose your storage options. The default is **Sysdig Storage**, where captures are stored for 90 days. 
...
3. Complete the configuration under the **Capture** section:
  ...
  - **Capture Storage**: The storage location for the capture files. The default is **Sysdig Storage**, where captures are stored for 90 days.
...
Captures saved in the Sysdig Storage older than 90 days will be automatically deleted. For longer storage, configure a custom S3 storage bucket.
...
To disable Captures altogether, edit the agent configuration file.
...
Both environments have the option to use a S3-compatible custom storage, such as [Minio](https://min.io/) or [IBM Cloud Object Storage](https://www.ibm.com/cloud/object-storage). This lets you store captures for longer periods of time.